		...
		if(isset($_POST['action']) || isset($_GET['autocomplete']))
		{
			...
			switch($action)
			{
				case 'verificar_existe':
				{
					...
					if($opciones_sistemas->existe($_POST['nombre']))
					{
						$salida['modo'] = 1;
				...
				case 'crear':
				{
					...
					$result = $opciones_sistemas->insert(strtoupper($_POST['nombre']), $_POST['descripcion']);
					$salida['mensaje'] = $mensaje;
				...
				case 'editar':
				{
					echo $opciones_sistemas->update($_POST['id'], $_POST['nombre'], $_POST['descripcion'], $_POST['estado']);
				...
				case 'eliminar':
				{
					echo $opciones_sistemas->drop($_POST['id']);
